...
public class diagCircle extends Connection{
    ...
    void initialize() {
        ...
        diagS.getData().add(new PieChart.Data(" Собственный капитал ", Double.valueOf(d.getAvailableSum())));
        diagS.getData().add(new PieChart.Data(" Инивестиции ", Double.valueOf(d.getGratInvest())));
